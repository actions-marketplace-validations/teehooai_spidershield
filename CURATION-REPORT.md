# AgentShield Curation Report

Batch scan of top MCP servers. Generated by `agentshield scan`.
...
### 2. Template-based rewriting delivers massive gains
- filesystem: 3.7 -> 8.5 (+4.8 points)
- git: 2.9 -> 9.5 (+6.6 points)
- supabase: 3.4 -> 9.0 (+5.6 points)
- **Average improvement: +5.7 points without any API calls**
...
Servers that would benefit most from AgentShield curation (high tool count + low description quality):
