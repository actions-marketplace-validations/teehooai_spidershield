...
We ran [TeeShield](https://github.com/teehooai/teeshield) against the most widely used MCP servers in the ecosystem:
...
Here's the same tool after TeeShield rewrites it:
...
We rewrote all 79 tool descriptions using TeeShield's template engine (zero cost, no API calls):
...
5. **Run TeeShield** before publishing: `pip install teeshield && teeshield scan .`

## Methodology

- Scanner: [TeeShield v0.1.0](https://pypi.org/project/teeshield/)
...
*This report was generated by [TeeShield](https://github.com/teehooai/teeshield), a static security linter for MCP tools. Install: `pip install teeshield`*
